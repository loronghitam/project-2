    ...
    <div class="site-section slider-team-wrap bg-light">
        <div class="container">
            ...
            <div class="slider-team owl-carousel no-nav owl-3-slider">
                <div class="team">
                    <div class="pic">
                        <img src="{{asset('asset/landingpage/images/person_1-min.jpg')}}" alt="Image" class="img-fluid">
                    </div>
                ...
                <div class="team">
                    <div class="pic">
                        <img src="{{asset('asset/landingpage/images/person_2-min.jpg')}}" alt="Image" class="img-fluid">
                    </div>
                ...
                <div class="team">
                    <div class="pic">
                        <img src="{{asset('asset/landingpage/images/person_3-min.jpg')}}" alt="Image" class="img-fluid">
                    </div>
                ...
                <div class="team">
                    <div class="pic">
                        <img src="{{asset('asset/landingpage/images/person_4-min.jpg')}}" alt="Image" class="img-fluid">
                    </div>
